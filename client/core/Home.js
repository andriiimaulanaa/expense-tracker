        ...
        <>
          ...
          { !auth.isAuthenticated() && typeof window !== "undefined" && 
            (<Card className={classes.card}>
              ...
              <Typography variant="body2" component="p" className={classes.credit} color="textSecondary">Photo by 
              <a href="https://unsplash.com/@anniespratt" target="_blank" rel="noopener noreferrer">Annie Spratt</a> on Unsplash</Typography>
              <CardContent>
